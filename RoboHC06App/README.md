...
Alguns modulos vendidos como HC-06 aparecem no Windows/Android como BLE UART (`FFE0`/`FFE1`) em vez de Bluetooth classico SPP. O app tenta BLE UART primeiro quando detectar esse perfil e usa RFCOMM como fallback.
